 ...
 * member of the LuminAI team is entering the customer's details to create their account. The
 * caller must hold the {@code PLATFORM_ADMIN} realm role in Keycloak — an internal-staff role,
 * distinct from any customer-facing {@code TENANT_ADMIN} role.
 *
