 ...
 * routed to by Hibernate's schema-based multi-tenancy. The explicit {@code schema = "public"}
 * below ensures this entity is always queried against {@code public.tenants} regardless of which
 * tenant schema is currently active on the connection's search_path.
 */
@Entity
