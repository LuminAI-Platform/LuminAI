...
public class KeycloakAdminClient {
     ...
     * with {@code UPDATE_PASSWORD} and {@code VERIFY_EMAIL} required actions so the person sets
     * their own credentials via the email Keycloak sends — LuminAI never generates or transmits a
     * password itself.
     *
                    ...
                    .uri(
                            uriBuilder ->
                                    uriBuilder
                                            ...
                                            .queryParamIfPresent(
                                                    "client_id",
                                                    java.util.Optional.ofNullable(properties.adminClientId()))
