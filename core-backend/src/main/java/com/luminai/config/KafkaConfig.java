...
public class KafkaConfig {
    ...
    public DeadLetterPublishingRecoverer deadLetterPublishingRecoverer() {
        return new DeadLetterPublishingRecoverer(
                ...
                (record, exception) -> {
                    log.error("Routing failed message to DLQ. topic={}, partition={}, offset={}, error={}",
    ...
    public DefaultErrorHandler kafkaErrorHandler() {
        ...
        errorHandler.setRetryListeners((record, ex, deliveryAttempt) ->
                log.warn("Kafka retry attempt {}/{} for topic={} partition={} offset={}",
                        deliveryAttempt, DLQ_MAX_ATTEMPTS,
                        record.topic(), record.partition(), record.offset()));

        return errorHandler;
    }

    //Listener container factory — wires the consumer factory, error handler and acknowledgement mode together
    @Bean
