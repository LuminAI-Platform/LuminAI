...
public class TenantIdentifierResolver
  ...
  //Indicates whether Hibernate should validate that a session was opened with the same tenant identifier that is currently active.
  @Override
  public boolean validateExistingCurrentSessions() {
    return true;
  }

  // Self-registers this resolver into Hibernate's property map via Spring Boot's {@link HibernatePropertiesCustomizer} contract.
  @Override
