...
/**
 * JPA entity representing a schema mapping configuration. Maps a single source column from a
 * connector's dataset to a target ontology entity-type property, with an optional transformation.
 *
