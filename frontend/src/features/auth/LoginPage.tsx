      ...
      <div className="w-full max-w-5xl grid grid-cols-1 md:grid-cols-12 gap-8 items-center relative z-10">
        ...
        <div className="md:col-span-7 flex flex-col justify-center gap-6">
          <div className="flex items-center gap-3">
            ...
            <div className="flex flex-col">
              <span className="text-xl font-bold tracking-tight text-zinc-100 leading-none">LuminAI</span>
              <span className="text-[10px] font-bold text-blue-500 tracking-widest uppercase mt-0.5">Enterprise OS</span>
            </div>
          </div>
          ...
          <div className="space-y-4">
            ...
            <p className="text-zinc-400 text-sm md:text-base leading-relaxed max-w-xl">
              Connect raw pipelines, define enterprise-wide semantic models, map ontology schemas, and deploy production-grade agent endpoints.
            </p>
          </div>
          ...
          <div className="grid grid-cols-3 gap-4 max-w-lg mt-2">
            <div className="bg-zinc-900/40 border border-zinc-800/60 rounded-xl p-4 flex flex-col gap-1 backdrop-blur-xs">
              <span className="text-zinc-500 text-[10px] font-mono uppercase tracking-wider">Deployments</span>
              <span className="text-lg font-bold text-zinc-200">1.2k+ / day</span>
            </div>
            <div className="bg-zinc-900/40 border border-zinc-800/60 rounded-xl p-4 flex flex-col gap-1 backdrop-blur-xs">
              <span className="text-zinc-500 text-[10px] font-mono uppercase tracking-wider">Data Ingestion</span>
              <span className="text-lg font-bold text-zinc-200">2.4 PB</span>
            </div>
            <div className="bg-zinc-900/40 border border-zinc-800/60 rounded-xl p-4 flex flex-col gap-1 backdrop-blur-xs">
              <span className="text-zinc-500 text-[10px] font-mono uppercase tracking-wider">Sync Latency</span>
          ...
          <div className="flex items-center gap-2 text-zinc-500 text-xs">
            ...
            <a href="http://localhost:8180" target="_blank" rel="noreferrer" className="text-blue-500 hover:underline">
              localhost:8180
            </a>
          </div>
        </div>
        ...
        <div className="md:col-span-5 bg-zinc-900/50 border border-zinc-800/80 rounded-2xl p-8 backdrop-blur-md relative shadow-2xl shadow-black/50">
          ...
          <div className="flex flex-col gap-2 mb-8">
            <h2 className="text-xl font-bold tracking-tight text-zinc-100">Secure Client Access</h2>
            <p className="text-xs text-zinc-400 leading-relaxed">
              Use your enterprise Single Sign-On (SSO) credentials to authenticate with Keycloak.
            </p>
          </div>
              ...
              <div className="space-y-3">
                <div className="bg-zinc-950/60 border border-zinc-850 p-3 rounded-lg flex items-center justify-between text-xs group">
                  <div className="flex flex-col gap-0.5">
                    ...
                    <span className="font-mono text-zinc-300">admin@luminai.dev</span>
                  </div>
                  <button
                  ...
                  >
                    {copiedField === 'user' ? (
                      <span className="text-[10px] text-emerald-500 font-semibold font-sans">Copied!</span>
                    ) : (
                ...
                <div className="bg-zinc-950/60 border border-zinc-850 p-3 rounded-lg flex items-center justify-between text-xs group">
                  <div className="flex flex-col gap-0.5">
                    <span className="text-[10px] text-zinc-500 font-medium">Password</span>
